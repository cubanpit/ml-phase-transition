...
L'analisi è stata effettuata sia su un set di configurazioni che su un set di vortici, per una rete convoluzionale con un kernel 2$\times$2 per il primo layer convoluzionale.
...
Anche per il modello XY si è provato ad stimare la temperatura di transizione di fase, unicamente per le configurazioni di vortici, che risultano essere 
%----------------------------------------------------------------------------------------
%	APPENDICES
%----------------------------------------------------------------------------------------
