...
\title{Apprendimento di transizioni di fase} % Title
...
\addlegendentry{$T_L$}
\addplot+[mark=none, green!70!black, thick, domain=0.0:0.06, samples=101]{0.2939*x + 1.5151};
\end{axis}
\end{tikzpicture}
\hfill
\begin{tikzpicture}
...
\addlegendentry{$T_L$}
\addplot+[mark=none, green!70!black, thick, domain=0.0:0.06, samples=101]{0.4167*x + 2.2653};
\end{axis}
\end{tikzpicture}
\hfill
\begin{tikzpicture}
...
\addlegendentry{$T_L$}
\addplot+[mark=none, green!70!black, thick, domain=0.0:0.06, samples=101]{0.3994*x + 3.6348};
\end{axis}
\end{tikzpicture}
...
\addlegendentry{$T_L$}
\addplot+[mark=none, green!70!black, thick, domain=0.0:0.6, samples=101]{-0.1331*x + 0.8978};
\end{axis}
\end{tikzpicture}
\hspace{2cm}
\begin{tikzpicture}
...
\addlegendentry{$T_L$}
\addplot+[mark=none, green!70!black, thick, domain=0.0:0.6, samples=101]{-0.2297*x + 0.9081};
\end{axis}
\end{tikzpicture}
\caption{Interpolazione temperatura}
\label{fig:xyTlimit}
...
In entrambi i casi i dati non sono sufficienti per avere una solida interpolazione lineare, in entrambi i casi l'errore relativo supera il $5\%$.
Si ottiene però una buona stima della temperatura di transizione, assolutamente compatibile con il valore teorico.
